      ...
      <div>
        ...
        <div style="margin-top: 10px">
          <van-grid :column-num="3" :border="false">
            <van-grid-item icon="like-o" style="color: red" :text="momentUser.followNum+' 关注'"/>
            <van-grid-item icon="fire-o" style="color: red;" :text="momentUser.fanNum+' 粉丝'"/>
            <van-grid-item icon="good-job-o" style="color: red" :text="momentUser.likes+' 获赞'"/>
          </van-grid>
        </div>
