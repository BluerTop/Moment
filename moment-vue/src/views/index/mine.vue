<template>
  <div style="background-color: #FAFAFA;margin-top: 5px">
    ...
    <!--动态-->
    <div v-show="status === 2 && !itemsNullShow" style="width: 95%; margin: 10px auto;padding-bottom: 20px">
      ...
      <div v-for="(item,index) in items" :key="index" style="margin-bottom: 20px;border-radius: 8px;background-color: white;padding: 10px">
        <div style="width: 100%;">
          <div class="van-cell van-cell--center" style="border-radius: 8px 8px 0 0 ">
            <i class="van-icon van-cell__left-icon">
      ...
      <van-divider @click="getItemsBefore" v-show="itemsIndexShow">点击加载更多</van-divider>
      <van-divider v-show="!itemsIndexShow">到底了...</van-divider>
    </div>
    <unsplash/>
